...
# ---------------------------------------------------------------------------
DATASET_NAME="coco_victim_first_caption"
...
EVAL_STEPS=20000
EXP_GROUP="lumi-inversion-sweep"

# ---------------------------------------------------------------------------
# Victim → embedder model name mapping
# ---------------------------------------------------------------------------
declare -A EMBEDDER_MODEL
EMBEDDER_MODEL["nomic"]="nomic-ai/nomic-embed-text-v1"
EMBEDDER_MODEL["gemini"]="nomic-ai/nomic-embed-text-v1"
EMBEDDER_MODEL["clip"]="nomic-ai/nomic-embed-text-v1"
...
for VICTIM in "${VICTIMS[@]}"; do
  for N in "${SAMPLE_SIZES[@]}"; do
    ...
    OUTPUT_DIR="saves/inverters/coco_${VICTIM}_${N}"
    EXP_NAME="${VICTIM}_${N}"
