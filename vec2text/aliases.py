...
lumi_dir_cos = "/scratch/project_465000909/cossim/vec2text_exp"
...
CHECKPOINT_FOLDERS_DICT = {
    ...
    # by script.
    "arab_script_32_me5": f"{lumi_dir}/saves/inverters/mt5_multilingual_e5_base_mt-ms_ara_scrp_32_2layers_prefix",
    "cyrl_script_32_me5": f"{lumi_dir}/saves/inverters/mt5_multilingual_e5_base_mt-ms_cyr_scrp_32_2layers_prefix",
    "latn_script_32_me5": f"{lumi_dir}/saves/inverters/mt5_multilingual_e5_base_mt-ms_lat_scrp_32_2layers_prefix",

    # one language

    "deu_Latn_32_me5": f"{lumi_dir}/saves/inverters/mt5_multilingual_e5_base_mt-ms_deu_Latn_32_2layers_prefix",
    "heb_Hebr_32_me5": f"{lumi_dir}/saves/inverters/mt5_multilingual_e5_base_mt-ms_heb_Hebr_32_2layers_prefix",
    "cmn_Hani_32_me5": f"{lumi_dir}/saves/inverters/mt5_multilingual_e5_base_mt-ms_cmn_Hani_32_2layers_prefix",

    # by family
    "indo-aryan_fami_32_me5": f"{lumi_dir}/saves/inverters/mt5_multilingual_e5_base_mt-ms_ind_fami_32_2layers_prefix",
    "semitic_fami_32_me5": f"{lumi_dir}/saves/inverters/mt5_multilingual_e5_base_mt-ms_sem_fami_32_2layers_prefix",
    "turkic_fami_32_me5": f"{lumi_dir}/saves/inverters/mt5_multilingual_e5_base_mt-ms_tur_fami_32_2layers_prefix",
    "atlatic_fami_32_me5": f"{lumi_dir}/saves/inverters/mt5_multilingual_e5_base_mt-ms_atl_fami_32_2layers_prefix",


    # correctors with cosine similarity.
    # by script
    "arab_script_32_me5_corrector": f"{lumi_dir_cos}/saves/correctors/mt5_multilingual_e5_base_mt-ms_ara_scrp_32_2layers_prefix_cos",
    "cyrl_script_32_me5_corrector": f"{lumi_dir_cos}/saves/correctors/mt5_multilingual_e5_base_mt-ms_cyr_scrp_32_2layers_prefix_cos",
    "latn_script_32_me5_corrector": f"{lumi_dir_cos}/saves/correctors/mt5_multilingual_e5_base_mt-ms_lat_scrp_32_2layers_prefix_cos",

    # one language

    "deu_Latn_32_me5_corrector": f"{lumi_dir_cos}/saves/correctors/mt5_multilingual_e5_base_mt-ms_deu_Latn_32_2layers_prefix_cos",
    "heb_Hebr_32_me5_corrector": f"{lumi_dir_cos}/saves/correctors/mt5_multilingual_e5_base_mt-ms_heb_Hebr_32_2layers_prefix_cos",
    "cmn_Hani_32_me5_corrector": f"{lumi_dir_cos}/saves/correctors/mt5_multilingual_e5_base_mt-ms_cmn_Hani_32_2layers_prefix_cos",

    # by family
    "indo-aryan_fami_32_me5_corrector": f"{lumi_dir_cos}/saves/correctors/mt5_multilingual_e5_base_mt-ms_ind_fami_32_2layers_prefix_cos",
    "semitic_fami_32_me5_corrector": f"{lumi_dir_cos}/saves/correctors/mt5_multilingual_e5_base_mt-ms_sem_fami_32_2layers_prefix_cos",
    "turkic_fami_32_me5_corrector": f"{lumi_dir_cos}/saves/correctors/mt5_multilingual_e5_base_mt-ms_tur_fami_32_2layers_prefix_cos",
    "atlatic_fami_32_me5_corrector": f"{lumi_dir_cos}/saves/correctors/mt5_multilingual_e5_base_mt-ms_atl_fami_32_2layers_prefix_cos",
