...
if __name__ == '__main__':
    ...
    for mode in ["multi", "mono"]:
        print(mode)
        print("*" * 20)
        filepath = f"language_confusion/langdist_data_all_langs/dataset2langdist_line_level_{mode}_0.3.json"
        get_model2langs(filepath, mode)
        print("*" * 20)
        filepath_word = f"language_confusion/langdist_data_all_langs/dataset2langdist_word_level_{mode}_0.3.json"
